...
#define FLUTTER_SCREEN_CAPTURE_PLUGIN(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), flutter_screen_capture_plugin_get_type(), \
...
void flutter_screen_capture_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
  FlutterScreenCapturePlugin* plugin = FLUTTER_SCREEN_CAPTURE_PLUGIN(
      g_object_new(flutter_screen_capture_plugin_get_type(), nullptr));
